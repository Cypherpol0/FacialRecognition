...
class MyCnnModel(nn.Module):
    def __init__(self):
        ...
        # output of the final DC layer  = 5 = number of classes
        self.fc16 = nn.Linear(50, 5)
...
def train_model(model, device, train_loader, val_loader, criterion, optimizer, num_epochs=5):
    ...
    for epoch in range(num_epochs):
        ...
        print(f'Epoch {epoch+1} \t Training Loss: {train_loss_result} \t Validation Loss: {val_loss_result} 
              \t Epoch Train Accuracy (%): {epoch_accuracy} \t Epoch Time (s): {epoch_time}')
